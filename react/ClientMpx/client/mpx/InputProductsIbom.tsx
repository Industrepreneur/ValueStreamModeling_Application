...
import * as inputProductsIbomHeaders from './inputProductsIbomHeaders'
...
const apiName = 'products-ibom'
const idColumn = 'ibomid'

export class InputProductsIbom extends React.Component<{}, {}> {
  state = {
    showAdvanced: false,
  ...
  _updateHeaders = () => {
    let headers = inputProductsIbomHeaders.buildHeaders(this.state.showAdvanced, this.state.selectedProductName, this.state.allProductNames)
  ...
  render() {
    ...
    let filteredData = _.filter(this.state.data, (c) => c.parentname === this.state.selectedProductName)
