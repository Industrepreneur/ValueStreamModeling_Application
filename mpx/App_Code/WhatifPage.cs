...
/// <summary>
/// Summary description for WhatifPage
/// </summary>
public abstract class WhatifPage: DbPage {
    ...
    private GridView GenerateGridControl() {
        ...
        for (int i = 1; i < FIELDS.Length; i++) {
            ...
            GridViewTemplate itemTemplate = new GridViewTemplate(ListItemType.Item, GridViewTemplate.DATA, FIELDS[i], LABEL_IDS[i]);
    ...
    protected string GetCommandString(int commandType, string[] selectedFields) {
    ...
    protected void InitializeComponent() {
        ...
        //popupPanel = panel.FindControl(InputPageControls.POPUP_PANEL) as Panel;
