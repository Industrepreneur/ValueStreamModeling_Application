<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="table.aspx.cs" EnableEventValidation="false" Inherits="labor" %>
    ...
    <div class="content-wrapper">
        ...
        <div class="panels" style="display: none;">
            ...
            <ajaxToolkit:TextBoxWatermarkExtender ID="TBWEinsertTable" runat="server"
                WatermarkText="Paste the labor records here."
