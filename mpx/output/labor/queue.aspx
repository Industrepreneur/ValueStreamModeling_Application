<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="queue.aspx.cs" Inherits="L_Queue" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="Server">
    ...
    <script type="text/javascript">
            ...
            $.ajax(
                {
                    ...
                    url: '/api/mpx/v1/output/l_queue.aspx/SetGoogleData',
        ...
        function drawVisualization(dataValues) {
            ...
            data.addColumn('number', 'AVG. EQUIPMENT TENDED');
            data.addColumn('number', 'AVG. EQUIPMENT WAITING');
            ...
            for (var i = 0; i < dataValues.length; i++) {
                ...
                if (Number(dataValues[i][2]) != null) {
                    var tend = Number(dataValues[i][2]);
                } else {
                    var tend = 0;
                }
                ...
                if (tend != 0) {
                    data.addRow([concat, name, scenario, myFunction(name, scenario, tend, wait), tend, wait, tend + wait, null]);
                }
        ...
        function myFunction(name, scenario, tend, wait) {

            var array = [];

            if (tend != null) {
                array.push('<div><span style="">TENDED: </span><span style="font-weight:900;">' + tend.toFixed(1) + '</span></div>');

            }
            if (wait != null) {
                array.push('<div><span style="">WAITING: </span><span style="font-weight:900;">' + wait.toFixed(1) + '</span></div>');
