<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="wip.aspx.cs" Inherits="P_WIP" %>
    ...
    <script type="text/javascript">
            ...
            $.ajax(
                {
                    ...
                    url: '/api/mpx/v1/output/p_wip.aspx/SetGoogleData',
        ...
        function drawVisualization(dataValues) {
            ...
            for (var i = 0; i < dataValues.length; i++) {
                ...
                if (wip != 0) {
                    data.addRow([concat, name, scenario, myFunction(name, scenario, wip), wip, null]);
                }
            ...
            if (data.getNumberOfRows() != 0) {
                ...
                for (var i = 0; i < numNames; i++) {
                    ...
                    var nameMax = tempView.getColumnRange(4);
                ...
                data.sort([5, { column: 4, desc: true }]);
        ...
        function myFunction(name, scenario, wip) {

            var array = [];

            if (wip != null) {
                array.push('<div><span style="">AVERAGE WIP: </span><span style="font-weight:900;">' + wip.toFixed(1) + '</span></div>');
